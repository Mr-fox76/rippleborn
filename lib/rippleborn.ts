...
const CARD_WISDOM: Record<string, string> = {
  ...
  'Prism Wisp': 'It slips between colors, leaving a brighter path where certainty once stood.',
  'Moss Oracle': 'Every prophecy begins as a quiet root beneath the noise of the world.',
  'Velvet Moth': 'Drawn to impossible light, it carries midnight softly upon its wings.',
  'Spiral Grazer': 'It feeds along the curve of forever, never crossing the same horizon twice.',
  'Echo Snail': 'Within its shell, every forgotten voice is still making its way home.',
  'Lantern Bloom': 'It opens only in darkness, proving that night can teach light how to grow.',
  'Mirror Stag': 'Look into its crown and meet the self that chose the road not taken.',
  'Thought Diver': 'Down through the mind it falls, returning with pearls no waking hand can hold.',
  'Time Eater': 'It does not chase the hours; it waits where every lost moment eventually arrives.',
  'Lucid Shepherd': 'With a silver call, it gathers wandering dreams before dawn can scatter them.',
  'Cathedral Jelly': 'A silent sanctuary drifts through the deep, lit by prayers without words.',
  'The Door Between': 'It opens only when you stop asking where it leads and decide who will cross.',
  'Laughing Mountain': 'Its joy rolls through the abyss like thunder, shaking old fears from their roots.',
  'Synapse Serpent': 'It coils between one thought and the next, striking before doubt can form.',
  'Choir of the Unseen': 'What has no face still has a voice, and together they sing the hidden world awake.',
  'The Garden That Remembers': 'Every fallen dream flowers here, exactly as the heart first imagined it.',
  'Infinity Gardener': 'Patient hands prune the endless, making room for one perfect possibility.',
  'The Moon Inside': 'Beyond the final veil, a private moon keeps watch over the tides of the soul.',
