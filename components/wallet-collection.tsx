        ...
        {card ? (
          <div className="grid gap-6 md:grid-cols-[minmax(0,1.5fr)_minmax(16rem,0.5fr)] md:items-center">
            <div className="mx-auto w-full max-w-sm">
              <CardWithFrame rarity={card.rarity} edition={card.discoveryNumber}>
  ...
  function renderSlot(slot: CollectionCatalogSet['slots'][number]) {
    ...
    const content = (
      <div className="collection-frame-slot group">
            <CardWithFrame rarity={slot.rarity} edition={card?.discoveryNumber} className={card ? '' : 'card-frame--missing'}>
